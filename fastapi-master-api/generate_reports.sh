...
pytest --cov=./app --cov-report html:./reports/coverage --cov-report xml:./reports/coverage/coverage.xml --junitxml=reports/junit/junit.xml --html=reports/junit/report.html
